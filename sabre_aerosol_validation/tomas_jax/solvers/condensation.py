...
from ..core.config import (
    ...
    MW_H2SO4, SV_H2SO4, CS_EPS, _DENS_INIT,
)
...
from ..physics.sedimentation import sedimentation_step
...
_VALID_MAKE_STEP_KWARGS = {
    ...
    # sedimentation
    'layer_depth', 'Nk_above', 'Mk_above', 'sed_density',
}
...
def make_step(processes, cond_method='ppm_jit', nucl_scheme='ricco_dunne',
    ...
    def step_fn(Nk, Mk, Gc, xk, temp, pres, boxvol, rh, alpha, dt, **kwargs):
        ...
        for process in processes:
            ...
            elif process == 'sedimentation':
                Nk, Mk, _, _ = sedimentation_step(
                    Nk, Mk, xk, temp, pres, dt,
                    kwargs.get('layer_depth', 1.0e30),
                    kwargs.get('Nk_above', jnp.zeros_like(Nk)),
                    kwargs.get('Mk_above', jnp.zeros_like(Mk)),
                    density=kwargs.get('sed_density', _DENS_INIT),
                )
